...
public class ProductResource {
	...
	public ResponseEntity<Page<ProductDTO>> findAllPaged(
			...
			@RequestParam(value = "linesPerPage", defaultValue = "12") Integer linesPerPage, // quantos registros por pagina
	...
	@PostMapping
	public ResponseEntity<ProductDTO> insert(@RequestBody ProductDTO dto) { // vai ser por json
